...
- runtime exposes `/diagnostics/generation-runs/maintenance` as process-local, bounded diagnostics for recent startup reconciliation, stale-run reconciliation, and replay-prune outcomes; this is operational visibility, not durable recovery state
