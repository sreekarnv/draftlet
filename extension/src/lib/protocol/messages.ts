...
export const latestGmailDraftResponseSchema = responseSchema(
...
export type GetLatestGmailDraftMessage = z.infer<
	typeof getLatestGmailDraftMessageSchema
>;
export type InsertGmailDraftMessage = z.infer<
	typeof insertGmailDraftMessageSchema
>;
