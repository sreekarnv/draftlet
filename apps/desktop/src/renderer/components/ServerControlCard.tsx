    ...
    <Card className="col-span-full content-start">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h2 className="m-0 text-base font-bold leading-tight text-slate-900">Start Draftlet server</h2>
        </div>
      ...
      {status.code === 'conflict' ? <small className="text-[13px] leading-6 text-rose-700">Draftlet will not stop or replace a process unless /health identifies it as Draftlet.</small> : null}
