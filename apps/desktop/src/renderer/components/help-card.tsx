    ...
    <Card className="col-span-full content-start">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h2 className="m-0 text-base font-bold leading-tight text-slate-900">Load extension and try a draft</h2>
        </div>
        <Badge tone={ready ? 'success' : 'neutral'}>{ready ? 'Server ready' : 'After setup'}</Badge>
      </div>
      <p className="m-0 text-sm leading-6 text-slate-600">Load the unpacked browser extension, then use the side panel to generate and review your first draft.</p>
      <ol className="m-0 grid gap-2 pl-5 text-sm leading-6 text-slate-600">
        ...
        <li>Select text on a page, open Draftlet, generate a draft, then Insert or Copy.</li>
      </ol>
